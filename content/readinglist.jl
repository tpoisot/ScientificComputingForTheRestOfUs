...
# Julia, and very thorough. Finally, ["Hands-on design patterns and best
# practices with Julia"][handson] is a wonderfully accessible book that will
# make you a better programmer, even if *Julia* is not your main language.

# If you still have some time, you can read something about [ways to improve
# user confidence in your software][userconf], or ways to [elevate code as a
# research output][elevate].

# [Code is Science][codeissci] is a very nice project about making peer review
# of scientific code more common. They have a list of [issues you can
