...
# "All" we have done so far is to split the *prepare* step into the preparation
# of solid and liquid ingredients. To come up with a full flowchart, we need to
...
# note *actions*, and anything else will be either an output or an input of
# these actions.

# !!! OPINION We like the idea of using different shapes to indicate different
...
# If we repeat the exercise for most of the boxes, we may end up with a
# flowchart like this. It might seem a little overwhelming at first, but this is
# a helpful document. It maps out the precise steps and processes in your
# project, and can help you both to *plan* what to write, but also to
# *understand* what you have written previously.
